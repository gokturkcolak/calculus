...
ax.plot_surface(x_grid_outer, y_grid_outer, z_grid, alpha=0.7, rstride=5, cstride=5, color='b')

# Plot the inner surface
ax.plot_surface(x_grid_inner, y_grid_inner, z_grid, alpha=0.7, rstride=5, cstride=5, color='r')

# Set labels
ax.set_xlabel('X (cm)')
ax.set_ylabel('Y (cm)')
ax.set_zlabel('Z (cm)')
ax.set_title('Hollow Cylinder in 3D Coordinate System')
